...
mod tests {
    ...
    context_tests! {
        ...
        test_code_rand_points: ("( 5 CODE.RAND )", "( CODE.QUOTE ( NAME.EQUAL CODE.DONCOUNT EXEC.ROT ) )", vec![]),
        test_code_rand_no_name_points: ("( 5 CODE.RANDNONAME )", "( CODE.QUOTE ( CODE.LIST NAME.EQUAL FLOAT.FLUSH ) )", vec![]),
