...
mod tests {
    ...
    context_tests! {
        ...
        // test_exec_define: ("( A TRUE EXEC.DEFINE A )", "( TRUE )", vec![]),
        ...
        // test_int_define: ("( A 1 INTEGER.DEFINE A )", "( 1 )", vec![]),
        // test_int_difference: ("( 3 1 INTEGER.DIFFERENCE )", "( 2 )", vec![]),
        // test_int_dup: ("( 42 INTEGER.DUP )", "( 42 42 )", vec![]),
        // test_int_equal: ("( 42 0 INTEGER.EQUAL )", "( FALSE )", vec![]),
        // test_int_flush: ("( 1 1 INTEGER.FLUSH )", "( )", vec![]),
        // test_int_fromboolean: ("( TRUE INTEGER.FROMBOOLEAN FALSE INTEGER.FROMBOOLEAN )", "( 1 0 )", vec![]),
        // test_int_fromfloat: ("( 5.0 INTEGER.FROMFLOAT )", "( 5 )", vec![]),
        // test_int_greater: ("( 5 3 INTEGER.GREATER )", "( TRUE )", vec![]),
        // test_int_less: ("( 5 3 INTEGER.LESS )", "( FALSE )", vec![]),
        // test_int_max: ("( 5 3 INTEGER.MAX )", "( 5 )", vec![]),
        // test_int_min: ("( -5 3 INTEGER.MIN )", "( -5 )", vec![]),
        // test_int_modulo: ("( -5 3 INTEGER.MODULO )", "( -2 )", vec![]),
        // test_int_modulo_zero: ("( -5 0 INTEGER.MODULO )", "( )", vec![]),
        // test_int_pop: ("( 42 INTEGER.POP )", "( )", vec![]),
        // test_int_product: ("( -5 3 INTEGER.PRODUCT )", "( -15 )", vec![]),
        // test_int_quotient: ("( 15 3 INTEGER.QUOTIENT )", "( 5 )", vec![]),
        // test_int_quotient_zero: ("( 15 0 INTEGER.QUOTIENT )", "( )", vec![]),
        // test_int_rand: ("( INTEGER.RAND )", "( 1 )", vec![]),
        // test_int_rot: ("( 0 1 2 INTEGER.ROT )", "( 1 2 0 )", vec![]),
        // test_int_shove: ("( 1 2 3 2 INTEGER.SHOVE )", "( 3 1 2 )", vec![]),
        // test_int_shove_zero: ("( 1 2 3 0 INTEGER.SHOVE )", "( 1 2 3 )", vec![]),
        // test_int_shove_wrap: ("( 1 2 3 3 INTEGER.SHOVE )", "( 1 2 3 )", vec![]),
        // test_int_stack_depth: ("( 1 2 INTEGER.STACKDEPTH )", "( 1 2 2 )", vec![]),
        // test_int_sum: ("( 42 7 INTEGER.SUM )", "( 49 )", vec![]),
        // test_int_swap: ("( 1 2 3 INTEGER.SWAP )", "( 1 3 2 )", vec![]),
        // test_int_yank: ("( 1 2 3 4 2 INTEGER.YANK )", "( 1 3 4 2 )", vec![]),
        // test_int_yank_dup: ("( 1 2 3 4 2 INTEGER.YANKDUP )", "( 1 2 3 4 2 )", vec![]),
