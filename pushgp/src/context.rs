...
mod tests {
    ...
    context_tests! {
        ...
        test_code_mutate: ("( CODE.QUOTE ( A ( ( B ) C ) D ) CODE.MUTATE )", "( CODE.QUOTE ( ( INTEGER.GREATER CODE.DEFINE ) NAME.SHOVE CODE.DEFINITION EXEC.S ) )", vec![]),
        test_code_mutate_no_name: ("( CODE.QUOTE ( 1 ( ( 2 ) 3 ) 4 ) CODE.MUTATENONAME )", "( CODE.QUOTE ( ( CODE.DISCREPANCY INTEGER.GREATER ) CODE.EXTRACT CODE.DEFINE CODE.NTHCDR ) )", vec![]),
        ...
        test_code_rand_points: ("( 5 CODE.RAND )", "( CODE.QUOTE ( FLOAT.DUP CODE.DISCREPANCY CODE.EXTRACT ) )", vec![]),
        test_code_rand_no_name_points: ("( 5 CODE.RANDNONAME )", "( CODE.QUOTE ( FLOAT.TAN FLOAT.DUP EXEC.EQUAL ) )", vec![]),
        test_code_rand_child: ("( CODE.QUOTE ( A ( ( B ) C ) D ) CODE.QUOTE ( 1 ( ( 2 ) 3 ) 4 ) CODE.RANDCHILD )", "( CODE.QUOTE ( ( 1 ( ( 2 ) 3 ) 4 ) ( ( B ) C ) D ) CODE.QUOTE A )", vec![]),
        test_code_rand_child_no_name: ("( CODE.QUOTE ( 1.0 ( ( 2.0 ) 3.0 ) 4.0 ) CODE.QUOTE ( 1 ( ( 2 ) 3 ) 4 ) CODE.RANDCHILDNONAME )", "( CODE.QUOTE ( ( 1 ( ( 2 ) 3 ) 4 ) ( ( 2.0 ) 3.0 ) 4.0 ) CODE.QUOTE 1.0 )", vec![]),
