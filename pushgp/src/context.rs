...
mod tests {
    ...
    context_tests! {
        ...
        test_code_atom_null: ("( CODE.ATOM )", "( )", vec![]),
        ...
        test_integer_modulo_zero: ("( -5 0 INTEGER.MODULO )", "( -5 0 )", vec![]),
        ...
        test_integer_quotient_zero: ("( 15 0 INTEGER.QUOTIENT )", "( 15 0 )", vec![]),
        ...
        test_integer_sum_below_min: ("( -9223372036854775808 -1 INTEGER.SUM )", "( -9223372036854775808 )", vec![]),
